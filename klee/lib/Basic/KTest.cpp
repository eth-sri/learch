...
//   std::cout << "numArgs: " << res->numArgs << std::endl;
//   for (i=0; i<res->numArgs; i++) {
//     std::cout << "arg " << i << ": " << res->args[i] << std::endl;
//   }
//   std::cout << "symArgvs: " << res->symArgvs << std::endl;
//   std::cout << "symArgvLen: " << res->symArgvLen << std::endl; 
//   std::cout << "numObjects: " << res->numObjects << std::endl;
//   for (i=0; i<res->numObjects; i++) {
//     KTestObject *o = &res->objects[i];
//     std::cout << "object " << i << " name: " << o->name << std::endl;
//     std::cout << "object " << i << " numBytes: " << o->numBytes << std::endl;
//     std::cout << "object " << i << " bytes: " << o->bytes << std::endl;
//   }
// 
  fclose(f);
